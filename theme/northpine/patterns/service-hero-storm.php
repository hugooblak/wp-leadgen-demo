<?php
/**
 * Title: Service hero: Storm &amp; hail damage
 * Slug: northpine/service-hero-storm
...
<p class="is-style-eyebrow">Storm &amp; hail damage</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading">Storm damage? Get it checked before the next rain.</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"ink-soft","fontSize":"large"} -->
<p class="has-ink-soft-color has-text-color has-large-font-size">Free inspection with a photo report you can send to your insurer. We can meet your adjuster on site and handle the repair.</p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"className":"np-track-cta"} -->
<div class="wp-block-button np-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo $url( '/free-quote/?service=storm' ); ?>">Get my free quote</a></div>
<!-- /wp:button -->
